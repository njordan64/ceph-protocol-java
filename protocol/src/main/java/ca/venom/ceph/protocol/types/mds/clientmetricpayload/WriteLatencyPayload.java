...
/**
 * [Ceph URL] https://github.com/ceph/ceph/blob/1d146b4afffae5eb9031693f85cd9eabfc308679/src/include/cephfs/metrics/Types.h#L209
 */
@CephType
@CephTypeVersionConstant(version = 2, compatVersion = 1)
@CephTypeSize
public class WriteLatencyPayload extends ClientMetricPayload {
    @Getter
    @Setter
    ...
    public WriteLatencyPayload() {
        super(ClientMetricType.WRITE_LATENCY);
    }
}
