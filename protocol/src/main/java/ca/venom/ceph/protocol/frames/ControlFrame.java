...
public abstract class ControlFrame {
    ...
    public abstract void encodeSegment1(ByteBuf byteBuf, boolean le, BitSet features) throws EncodingException;
    ...
    public abstract void decodeSegment1(ByteBuf byteBuf, boolean le, BitSet features) throws DecodingException;
